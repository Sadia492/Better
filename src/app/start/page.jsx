  ...
  return (
    <div className="pb-12">
      ...
      <div className="flex flex-col justify-center items-center gap-8 mt-8">
        <div className="">
          <button className="flex rounded-lg items-center justify-center gap-4 border-2 border-black py-2 px-4 w-96 hover:border-4 hover:border-accent box-border">
            <svg
              fill="transparent"
              height="36"
              viewBox="0 0 36 36"
            ...
            <span className="font-bold">Buying A Home</span>
          </button>
        </div>
        <div>
          <button className="flex items-center justify-center gap-4 border-2 border-black py-2 px-4 w-96 hover:border-4 rounded-lg hover:border-accent box-border">
            <svg
              fill="transparent"
              height="36"
              viewBox="0 0 36 36"
            ...
            <span className="font-bold">Refinance my mortgage</span>
          </button>
        </div>
        <div>
          <button className="flex items-center justify-center gap-4 border-2 border-black py-2 px-4 w-96 hover:border-4 hover:border-accent transition-all duration-300 rounded-lg box-border">
            <svg
              fill="transparent"
              height="36"
              viewBox="0 0 36 36"
            ...
            <span className="font-bold">Get cash from my home</span>
          </button>
        </div>
      </div>
      {/* amount */}
      <div className="flex justify-center items-center text-center gap-6 mt-12">
        <div>
          <h2 className="font-bold text-4xl">$100B</h2>
          <p>home loans funded entirely online</p>
        </div>
        <div>
          <h2 className="font-bold text-4xl">400K</h2>
          <p>Customers who chose a Better Mortgage</p>
        </div>
      </div>
      {/* few questions */}
      <div className="bg-accent/10 w-fit mx-auto px-12 mt-12 py-8 space-y-3 rounded-lg">
        ...
        <p className="flex gap-2 ml-3">
          <svg
            className="MuiSvgIcon-root MuiSvgIcon-fontSizeMedium css-1xbrwhv w-5  text-accent"
            focusable="false"
            aria-hidden="true"
            viewBox="0 0 24 24"
